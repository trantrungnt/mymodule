<!-- BEGIN: main -->
		<table class="tab1">
			...
			<tr>
				...
				<td> <a href="index.php?language=vi&nv=cmt&op=cmt_update&cmnd_code={DATA.cmnd}">Sửa</a></td>
				<td> <a href="index.php?language=vi&nv=cmt&op=delete_CMND&cmnd_code={DATA.cmnd}">Xóa</a></td>
			</tr>
			<!-- END: loop -->
		</table>
<!-- END: main -->
